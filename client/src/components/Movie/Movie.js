...
const Watch = (props)=>{
    ...
    useEffect(() => {
        ...
        async function fetchDetails(){
            ...
            let request=null
            request = await axios.get(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${API_KEY}&language=pt`)
            if(request.data)
            {
        ...
        toget_related_movies = `movie/${props.match.params.id}/recommendations?api_key=${API_KEY}&language=pt`
    ...
    const addToWatchListHandler = ()=>{
        ...
        axios.put(`http://localhost:3709/watchlist`,{
            ...
            <div>
                <div className='watch-item'>
                    ...
                    <div className='wi-extra-info-content' >
                        { 
                            isRelatedActive ? 
                            <Row title='Itens semelhantes' fetchUrl={toget_related_movies} mediaType='movie' />
                            : null
                        }
                        {
                            isDetailsActive ? 
